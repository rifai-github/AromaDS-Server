...
class Invoice extends Model
{
    ...
    /**
     * Raised by the system rather than typed in by someone.
     *
     * created_by still holds whoever was authenticated when the record was
     * written - for an automatic invoice that is the technician who closed the
     * job, not its author - so it must not be shown as the creator here.
     */
    public function isAutoGenerated(): bool
    {
        return ($this->creation_source ?? 'auto') !== 'manual';
    }
