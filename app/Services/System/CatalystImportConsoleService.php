    ...
    public function actions(): array
    {
        return [
            ...
            'dry_run_master_rentals' => [
                'label' => 'Dry Run Master Rental Import',
                'description' => 'Simulasikan import Master Rental (master_rentals, rental_components, rental_details) dari Catalyst MsProduct/MsRentalBOM tanpa menulis ke database dan tanpa mengulang dependency import.',
                'group' => 'migration',
                'execution' => 'sync',
                'commands' => [
                    $this->artisanCommand([
            ...
            'apply_master_rentals' => [
                'label' => 'Apply Master Rental Import',
                'description' => 'Import Master Rental (master_rentals, rental_components, rental_details) dari Catalyst. Dikecualikan dari Full Migration - jalankan ini secara manual sebelum step yang butuh mapping rental (quotation_rentals, contract_rentals, job_advice_rooms).',
                'group' => 'migration',
                'execution' => 'sync',
                'commands' => [
                    $this->artisanCommand([
            ...
            'dry_run_backfill_building_city' => [
                'label' => 'Dry Run Backfill Building City & District',
                'description' => 'Simulasikan pengisian city_id/province_id dan district_id Master Building yang kosong/orphaned/soft-deleted, dicocokkan dari CityName/AreaCity (notes) dan AreaServiceName (description) yang sudah tersimpan hasil import. Tidak menulis ke database.',
                'group' => 'post_import',
                'execution' => 'sync',
                'commands' => [
            ...
            'apply_backfill_building_city' => [
                'label' => 'Apply Backfill Building City & District',
                'description' => 'Isi city_id/province_id dan district_id Master Building yang kosong/orphaned/soft-deleted berdasarkan CityName/AreaCity (notes) dan AreaServiceName (description) yang sudah tersimpan hasil import Catalyst.',
                'group' => 'post_import',
                'execution' => 'sync',
                'commands' => [
