...
$(document).ready(function() {
    ...
    $(document).on('click', '#save-draft-btn', function(e) {
        ...
        const updateData = {
            ...
            building_name: '{{ $survey->building->nama_gedung ?? $survey->building->name ?? $survey->building_name }}',
            address_1: '{{ $survey->building->alamat_1 ?? $survey->building->address ?? $survey->address_1 }}',
