...
@section('title', 'Create Commission Level')
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1 class="h3 mb-0 text-gray-800">Create Commission Level</h1>
                    <p class="text-muted">Create a new commission level configuration</p>
                </div>
                <div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('finance.commission-levels.store') }}">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('target_type') is-invalid @enderror" 
                                        ...
                                        <option value="both" {{ old('target_type') == 'both' ? 'selected' : '' }}>Both</option>
                                    </select>
                                    @error('target_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" min="0" max="100" class="form-control @error('min_percentage') is-invalid @enderror" 
                                           id="min_percentage" name="min_percentage" value="{{ old('min_percentage') }}" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" min="0" max="100" class="form-control @error('max_percentage') is-invalid @enderror" 
                                           id="max_percentage" name="max_percentage" value="{{ old('max_percentage') }}">
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Create Commission Level
                            </button>
                            <a href="{{ route('finance.commission-levels.index') }}" class="btn btn-secondary">
