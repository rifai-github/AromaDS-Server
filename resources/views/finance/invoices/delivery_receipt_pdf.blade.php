...
$jobRefFull =
    $invoice->invoiceRentalDetails->pluck('job_no')->filter()->first() ?: ($invoice->contract_number ?: '');
$jobRefShort = '';
...
if ($footerAddrLine === '') {
    $footerAddrLine =
        'Komplek Kedoya Center Blok C 8- 9 Jl. Raya Pejuangan No. 1 Kebon Jeruk, Jakarta Barat 11530. INDONESIA Tel.62 21 533 3405, 549 |49|, Fax 62 21 533 3406 - 07';
} else {
    $footerAddrLine .= ' Tel.62 21 533 3405, 549 |49|, Fax 62 21 533 3406 - 07';
}
$footerBranchLine =
    'Bali : 62 361 722 745  Batam : 62 778 461 601  Bandung : 62 22 730 4176  Surabaya : 62 31 849 6409-10  Semarang : 62 24 7617 314  Medan : 62 61 4146 494';
        ...
        <div class="receipt">
            ...
            <table class="rec-body">
                ...
                <tr>
                    ...
                    <td class="rb-sep">:</td>
                    <td>&nbsp;</td>
                    <td class="rb-right" style="font-weight: normal;">
                        <table>
                            <tr>
                                <td>Tanggal,</td>
                                <td>&nbsp;</td>
            ...
            <table class="rec-body" style="margin-top: 4px;">
                <tr class="sign-row">
                    <td class="sign-col" style="text-align: center;">Yang menyerahkan,</td>
                    <td class="sign-spacer">&nbsp;</td>
                    <td class="sign-col" style="text-align: center;">Yang menerima,</td>
                </tr>
                <tr></tr>
                <tr class="sign-row">
                    <td class="sign-col">
                        <div class="sign-name" style="text-align: center; margin-top: 43px;">{{ $dikirimOleh }}</div>
