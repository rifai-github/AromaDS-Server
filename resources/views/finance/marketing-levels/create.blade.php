...
@section('title', 'Create Marketing Level')
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1 class="h3 mb-0 text-gray-800">Create Marketing Level</h1>
                    <p class="text-muted">Create a new marketing level</p>
                </div>
                <div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('finance.marketing-levels.store') }}">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('level_code') is-invalid @enderror" 
                                           id="level_code" name="level_code" value="{{ old('level_code') }}" required>
                                    @error('level_code')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <small class="form-text text-muted">e.g., M1, M2, Manager</small>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Create Marketing Level
                            </button>
                            <a href="{{ route('finance.marketing-levels.index') }}" class="btn btn-secondary">
