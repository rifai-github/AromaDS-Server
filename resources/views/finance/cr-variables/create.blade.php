...
@section('title', 'Create CR Variable')
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1 class="h3 mb-0 text-gray-800">Create CR Variable</h1>
                    <p class="text-muted">Create a new Cash Receipt period variable</p>
                </div>
                <div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('finance.cr-variables.store') }}">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    @enderror
                                    <small class="form-text text-muted">e.g., Default Cash Receipt Period</small>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" min="1" max="365" class="form-control @error('cr_days') is-invalid @enderror" 
                                           id="cr_days" name="cr_days" value="{{ old('cr_days') }}" required>
                                    @error('cr_days')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <small class="form-text text-muted">Number of days for cash receipt period (e.g., 90)</small>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    @error('is_default')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <small class="form-text text-muted">Only one variable can be default</small>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Create CR Variable
                            </button>
