...
@section('title', 'Edit Job Assign Schedule - Operational')
@section('breadcrumb', 'Home / Operational / Job Assign Schedule / Edit')
...
<div class="w-full">
    ...
    <div class="flex flex-row justify-between items-center w-full bg-white rounded-t-[10px] pt-[7px] pr-[7px] pb-[7px] pl-[7px] md:pt-[10px] md:pr-[10px] md:pb-[10px] md:pl-[10px] lg:pt-[14px] lg:pr-[14px] lg:pb-[14px] lg:pl-[14px]">
        <div class="flex flex-row justify-start items-center w-full">
            <p class="text-[8px] md:text-[12px] lg:text-[16px] font-inter font-medium leading-[10px] md:leading-[15px] lg:leading-[20px] text-left text-[#214589] w-auto">Edit Job Assign Schedule</p>
        </div>
    ...
    <div class="content-container w-full bg-white rounded-b-[10px] p-[7px] md:p-[10px] lg:p-[14px]">
        <form id="jobAssignmentForm" method="POST" action="{{ route('operational.job-assign-schedules.update', $jobAssignment->id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select @error('team_id') border-red-500 @enderror" 
                            ...
                            @foreach($teams ?? [] as $team)
                                <option value="{{ $team->id }}" {{ old('team_id', $jobAssignment->team_id) == $team->id ? 'selected' : '' }}>
                                    {{ $team->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select @error('building_id') border-red-500 @enderror" 
                            ...
                            @foreach($buildings ?? [] as $building)
                                <option value="{{ $building->id }}" {{ old('building_id', $jobAssignment->building_id) == $building->id ? 'selected' : '' }}>
                                    {{ $building->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select @error('room_id') border-red-500 @enderror" 
                            ...
                            @foreach($rooms ?? [] as $room)
                                <option value="{{ $room->id }}" {{ old('room_id', $jobAssignment->room_id) == $room->id ? 'selected' : '' }}>
                                    {{ $room->room_name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select @error('job_type') border-red-500 @enderror" 
                            ...
                            <option value="installation" {{ old('job_type', $jobAssignment->job_type) == 'installation' ? 'selected' : '' }}>Installation</option>
                            <option value="maintenance" {{ old('job_type', $jobAssignment->job_type) == 'maintenance' ? 'selected' : '' }}>Maintenance</option>
                            <option value="repair" {{ old('job_type', $jobAssignment->job_type) == 'repair' ? 'selected' : '' }}>Repair</option>
                            <option value="inspection" {{ old('job_type', $jobAssignment->job_type) == 'inspection' ? 'selected' : '' }}>Inspection</option>
                            <option value="cleaning" {{ old('job_type', $jobAssignment->job_type) == 'cleaning' ? 'selected' : '' }}>Cleaning</option>
                            <option value="other" {{ old('job_type', $jobAssignment->job_type) == 'other' ? 'selected' : '' }}>Other</option>
                        </select>
                        @error('job_type')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" 
                               ...
                               id="schedule_date" 
                               name="schedule_date" 
                               value="{{ old('schedule_date', $jobAssignment->schedule_date) }}" 
                               required>
                        @error('schedule_date')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select @error('priority') border-red-500 @enderror" 
                                id="priority" 
                                name="priority">
                            <option value="low" {{ old('priority', $jobAssignment->priority) == 'low' ? 'selected' : '' }}>Low</option>
                            <option value="medium" {{ old('priority', $jobAssignment->priority) == 'medium' ? 'selected' : '' }}>Medium</option>
                            <option value="high" {{ old('priority', $jobAssignment->priority) == 'high' ? 'selected' : '' }}>High</option>
                        </select>
                        @error('priority')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <input type="time" 
                               ...
                               id="start_time" 
                               name="start_time" 
                               value="{{ old('start_time', $jobAssignment->start_time) }}" 
                               required>
                        @error('start_time')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <input type="time" 
                               ...
                               id="end_time" 
                               name="end_time" 
                               value="{{ old('end_time', $jobAssignment->end_time) }}" 
                               required>
                        @error('end_time')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" 
                               ...
                               value="{{ old('estimated_duration', $jobAssignment->estimated_duration) }}" 
                               min="0.5" 
                               step="0.5">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" 
                               ...
                               value="{{ old('required_materials', $jobAssignment->required_materials) }}" 
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-textarea @error('special_instructions') border-red-500 @enderror" 
                                  ...
                                  rows="3">{{ old('special_instructions', $jobAssignment->special_instructions) }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select @error('status') border-red-500 @enderror" 
                                id="status" 
                                name="status">
                            <option value="pending" {{ old('status', $jobAssignment->status) == 'pending' ? 'selected' : '' }}>Pending</option>
                            <option value="in_progress" {{ old('status', $jobAssignment->status) == 'in_progress' ? 'selected' : '' }}>In Progress</option>
                            <option value="completed" {{ old('status', $jobAssignment->status) == 'completed' ? 'selected' : '' }}>Completed</option>
                            <option value="cancelled" {{ old('status', $jobAssignment->status) == 'cancelled' ? 'selected' : '' }}>Cancelled</option>
                        </select>
                        @error('status')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-textarea @error('description') border-red-500 @enderror" 
                                  id="description" 
                                  name="description" 
                                  rows="4">{{ old('description', $jobAssignment->description) }}</textarea>
                        @error('description')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-textarea @error('notes') border-red-500 @enderror" 
                                  id="notes" 
                                  name="notes" 
                                  rows="4">{{ old('notes', $jobAssignment->notes) }}</textarea>
                        @error('notes')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
