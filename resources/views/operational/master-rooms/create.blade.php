...
@section('title', 'Create Master Room - Operational')
@section('breadcrumb', 'Home / Operational / Master Room / Create')
...
<div class="w-full">
    ...
    <div class="flex flex-row justify-between items-center w-full bg-white rounded-t-[10px] pt-[7px] pr-[7px] pb-[7px] pl-[7px] md:pt-[10px] md:pr-[10px] md:pb-[10px] md:pl-[10px] lg:pt-[14px] lg:pr-[14px] lg:pb-[14px] lg:pl-[14px]">
        <div class="flex flex-row justify-start items-center w-full">
            <p class="text-[8px] md:text-[12px] lg:text-[16px] font-inter font-medium leading-[10px] md:leading-[15px] lg:leading-[20px] text-left text-[#214589] w-auto">Create Master Room</p>
        </div>
    ...
    <div class="content-container w-full bg-white rounded-b-[10px] p-[7px] md:p-[10px] lg:p-[14px]">
        <form id="roomForm" method="POST" action="{{ route('operational.master-rooms.store') }}" enctype="multipart/form-data">
            @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select @error('room_type') border-red-500 @enderror" 
                            ...
                            <option value="office" {{ old('room_type') == 'office' ? 'selected' : '' }}>Office</option>
                            <option value="meeting_room" {{ old('room_type') == 'meeting_room' ? 'selected' : '' }}>Meeting Room</option>
                            <option value="lobby" {{ old('room_type') == 'lobby' ? 'selected' : '' }}>Lobby</option>
                            <option value="corridor" {{ old('room_type') == 'corridor' ? 'selected' : '' }}>Corridor</option>
                            <option value="restroom" {{ old('room_type') == 'restroom' ? 'selected' : '' }}>Restroom</option>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select @error('scent_intensity') border-red-500 @enderror" 
                            ...
                            <option value="low" {{ old('scent_intensity') == 'low' ? 'selected' : '' }}>Low</option>
                            <option value="medium" {{ old('scent_intensity') == 'medium' ? 'selected' : '' }}>Medium</option>
                            <option value="high" {{ old('scent_intensity') == 'high' ? 'selected' : '' }}>High</option>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select @error('install_type') border-red-500 @enderror" 
                            ...
                            <option value="wall_mounted" {{ old('install_type') == 'wall_mounted' ? 'selected' : '' }}>Wall Mounted</option>
                            <option value="ceiling_mounted" {{ old('install_type') == 'ceiling_mounted' ? 'selected' : '' }}>Ceiling Mounted</option>
                            <option value="floor_standing" {{ old('install_type') == 'floor_standing' ? 'selected' : '' }}>Floor Standing</option>
                            <option value="duct_connected" {{ old('install_type') == 'duct_connected' ? 'selected' : '' }}>Duct Connected</option>
                        </select>
                        @error('install_type')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
