...
@section('title', 'Create Option Detail - ' . $masterOption->name)
@section('breadcrumb', 'Home / Other / Master Options / ' . $masterOption->name . ' / Create Detail')
...
<div class="form-container">
    <div class="form-header">
        <h1 class="form-title">Create New Option Detail</h1>
        <p class="form-subtitle">Add a new detail for {{ $masterOption->name }}</p>
    </div>

    <div class="form-body">
        <form action="{{ route('other.option-details.store', $masterOption) }}" method="POST">
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea id="option_description" 
                          ...
                          placeholder="Enter description (optional)">{{ old('option_description') }}</textarea>
            ...
            <div class="form-actions">
                <a href="{{ route('other.master-options.details', $masterOption) }}" class="btn btn-secondary">
