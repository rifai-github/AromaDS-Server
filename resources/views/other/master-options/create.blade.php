...
@section('title', 'Create Master Option')
@section('breadcrumb', 'Home / Company / Master Options / Create')
    ...
    <div class="flex flex-col justify-center items-start w-full max-w-[96%] mx-auto mb-[20px] md:mb-[30px] lg:mb-[40px]">
        ...
        <div class="flex flex-row justify-between items-center w-full bg-white rounded-t-[10px] pt-[7px] pr-[7px] pb-[7px] pl-[7px] md:pt-[10px] md:pr-[10px] md:pb-[10px] md:pl-[10px] lg:pt-[14px] lg:pr-[14px] lg:pb-[14px] lg:pl-[14px]">
            <div class="flex flex-row justify-start items-center w-full">
                <p class="text-[8px] md:text-[12px] lg:text-[16px] font-inter font-medium leading-[10px] md:leading-[15px] lg:leading-[20px] text-left text-[#214589] w-auto">Create Master Option</p>
            </div>
        </div>

        <!-- Form Container -->
        <div class="form-container w-full">
            <form action="{{ route('other.master-options.store') }}" method="POST" id="masterOptionForm">
                @csrf
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <div class="radio-group">
                            <div class="radio-option">
                                <input type="radio" id="system_reserved_yes" name="system_reserved" value="1" {{ old('system_reserved') == '1' ? 'checked' : '' }}>
                                <label for="system_reserved_yes">Yes</label>
                            </div>
                            <div class="radio-option">
                                <input type="radio" id="system_reserved_no" name="system_reserved" value="0" {{ old('system_reserved') == '0' ? 'checked' : '' }} checked>
                    ...
                    <div class="form-group">
                        ...
                        <div class="radio-group">
                            <div class="radio-option">
                                <input type="radio" id="is_active_yes" name="is_active" value="1" {{ old('is_active') == '1' ? 'checked' : '' }} checked>
                                <label for="is_active_yes">Yes</label>
                            </div>
                            <div class="radio-option">
                                <input type="radio" id="is_active_no" name="is_active" value="0" {{ old('is_active') == '0' ? 'checked' : '' }}>
                ...
                <div class="form-section">
                    ...
                    <div class="options-section">
                        ...
                        <div id="optionsContainer">
                            <!-- Option rows will be added here dynamically -->
                        </div>
                    </div>
                </div>
...
// Add initial option row when page loads
