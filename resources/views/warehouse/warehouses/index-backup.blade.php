        ...
        <div class="table-container">
            <table class="responsive-table">
                ...
                <tbody>
                    ...
                    <tr data-id="{{ $warehouse->id }}" onclick="openViewModal({{ $warehouse->id }})">
...
<div id="deleteModalOverlay" class="delete-modal-overlay" onclick="closeDeleteModal()">
    <div class="delete-modal-container" onclick="event.stopPropagation()">
        ...
        <h3 class="delete-modal-title">Hide Warehouse</h3>
        <p class="delete-modal-description" id="deleteMessage">Are you sure you want to hide this warehouse? This action can be undone later.</p>
...
<div id="errorModalOverlay" class="error-modal-overlay" onclick="closeErrorModal()">
    <div class="error-modal-container" onclick="event.stopPropagation()">
        ...
        <p class="delete-modal-description" id="errorMessage">We couldn't hide the warehouse. Please try again.</p>
        <div class="delete-modal-buttons">
...
<div id="successModalOverlay" class="success-modal-overlay" onclick="closeSuccessModal()">
    <div class="success-modal-container" onclick="event.stopPropagation()">
        ...
        <p class="delete-modal-description" id="successMessage">The warehouse has been successfully hidden.</p>
    </div>
</div>
                    ...
                    <div class="modal-section">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="manager" class="form-input" placeholder="Enter manager name">
                            </div>
                        </div>
                    </div>
            ...
            document.getElementById('modalBody').innerHTML = `
                <div class="modal-section">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="detail-item">
                            <label class="form-label">Manager</label>
                            <p class="detail-value">${data.manager || '-'}</p>
                        </div>
                    </div>
                </div>
                ...
                <form id="form" onsubmit="submitForm(event, ${id})">
                    <div class="modal-section">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="form-group">
                                <label class="form-label">Manager</label>
                                <input type="text" name="manager" class="form-input" value="${warehouse.manager || ''}" placeholder="Enter manager name">
                            </div>
                        </div>
                    </div>
...
function openDeleteModal() {
    ...
    const message = count === 1 
        ? 'Are you sure you want to hide this warehouse? This action can be undone later.'
        : `Are you sure you want to hide ${count} warehouses? This action can be undone later.`;
...
function showSuccessModal(count) {
    const message = count === 1 
        ? 'The warehouse has been successfully hidden.'
        : `${count} warehouses have been successfully hidden.`;
...
function showErrorModal(message) {
    document.getElementById('errorMessage').textContent = message || 'We couldn\'t hide the warehouse. Please try again.';
...
function deleteSelected() {
    ...
    if (checkboxes.length === 0) {
        alert('Please select at least one warehouse to hide');
        return;
    }
