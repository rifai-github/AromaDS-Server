...
@section('breadcrumb', 'Home / Other / Settings')
    ...
    <div class="flex flex-col justify-center items-start w-full max-w-[96%] mx-auto mb-[20px] md:mb-[30px] lg:mb-[40px]">
        ...
        <div class="flex flex-row justify-between items-center w-full bg-white rounded-t-[10px] pt-[7px] pr-[7px] pb-[7px] pl-[7px] md:pt-[10px] md:pr-[10px] md:pb-[10px] md:pl-[10px] lg:pt-[14px] lg:pr-[14px] lg:pb-[14px] lg:pl-[14px]">
            ...
            <div class="flex flex-row justify-end items-center w-auto">
                <button class="add-btn" onclick="window.location.href='{{ route('system.settings.create') }}'">
                    <i class="fas fa-plus text-white text-[7px] md:text-[10px] lg:text-[14px]"></i>
                    <span class="text-[7px] md:text-[10px] lg:text-[14px] font-inter font-medium leading-[8px] md:leading-[12px] lg:leading-[17px] text-center text-white">Create Setting</span>
                </button>
            </div>
        </div>
            ...
            <table class="w-full min-w-[1400px] border-collapse">
                ...
                <thead>
                    <tr class="bg-[#225fd3]">
                        ...
                        <th class="w-[200px] p-2 text-left" data-column="key">
                            <p class="text-[6px] md:text-[9px] lg:text-[12px] font-inter font-bold leading-[7px] md:leading-[11px] lg:leading-[15px] text-white">Setting Key</p>
                        </th>
                        <th class="w-[200px] p-2 text-left" data-column="value">
                            <p class="text-[6px] md:text-[9px] lg:text-[12px] font-inter font-bold leading-[7px] md:leading-[11px] lg:leading-[15px] text-white">Setting Value</p>
                        </th>
                        <th class="w-[150px] p-2 text-left" data-column="category">
                            <p class="text-[6px] md:text-[9px] lg:text-[12px] font-inter font-bold leading-[7px] md:leading-[11px] lg:leading-[15px] text-white">Category</p>
                        </th>
                        <th class="w-[150px] p-2 text-left" data-column="description">
                        ...
                        <th class="w-[100px] p-2 text-left" data-column="type">
                            <p class="text-[6px] md:text-[9px] lg:text-[12px] font-inter font-bold leading-[7px] md:leading-[11px] lg:leading-[15px] text-white">Type</p>
                        </th>
                        ...
                        <th class="w-[150px] p-2 text-left" data-column="updated_at" data-type="date">
                            <p class="text-[6px] md:text-[9px] lg:text-[12px] font-inter font-bold leading-[7px] md:leading-[11px] lg:leading-[15px] text-white">Latest Update</p>
                        </th>
                        <th class="w-[120px] p-2 text-left" data-column="updater.name">
                            <p class="text-[6px] md:text-[9px] lg:text-[12px] font-inter font-bold leading-[7px] md:leading-[11px] lg:leading-[15px] text-white">Update By</p>
                        </th>
                    </tr>
                </thead>
                ...
                <tbody>
                    ...
                    <tr class="table-row-hover cursor-pointer border-b border-gray-200" onclick="window.location.href='{{ route('system.settings.edit', $setting->id) }}'">
                        ...
                        <td class="w-[200px] p-2">
                            <p class="text-[6px] md:text-[9px] lg:text-[12px] font-inter font-normal leading-[7px] md:leading-[11px] lg:leading-[15px] text-left text-[#3d3d3d] break-words">{{ $setting->key ?? 'N/A' }}</p>
                        </td>
                        <td class="w-[200px] p-2">
                            <p class="text-[6px] md:text-[9px] lg:text-[12px] font-inter font-normal leading-[7px] md:leading-[11px] lg:leading-[15px] text-left text-[#3d3d3d] break-words">{{ Str::limit($setting->value, 50) ?? 'N/A' }}</p>
                        </td>
                        <td class="w-[150px] p-2">
                            <p class="text-[6px] md:text-[9px] lg:text-[12px] font-inter font-normal leading-[7px] md:leading-[11px] lg:leading-[15px] text-left text-[#3d3d3d] break-words">{{ $setting->category ?? 'N/A' }}</p>
                        </td>
                        <td class="w-[150px] p-2">
                            <p class="text-[6px] md:text-[9px] lg:text-[12px] font-inter font-normal leading-[7px] md:leading-[11px] lg:leading-[15px] text-left text-[#3d3d3d] break-words">{{ $setting->description ?? 'N/A' }}</p>
                        </td>
                        <td class="w-[100px] p-2">
                            @php
                                ...
                                $typeColor = $typeColors[strtolower($setting->type)] ?? 'badge-secondary';
                            @endphp
                            <span class="badge {{ $typeColor }}">{{ ucfirst($setting->type) ?? 'N/A' }}</span>
                        </td>
                        <td class="w-[100px] p-2">
                        ...
                        <td class="w-[150px] p-2">
                            <p class="text-[6px] md:text-[9px] lg:text-[12px] font-inter font-normal leading-[7px] md:leading-[11px] lg:leading-[15px] text-left text-[#3d3d3d] break-words">
                                {!! $setting->updated_at ? \Carbon\Carbon::parse($setting->updated_at)->format('d/M/Y') . '<br />at ' . \Carbon\Carbon::parse($setting->updated_at)->format('H.i') . ' WIB' : 'N/A' !!}
                            </p>
                        </td>
                        <td class="w-[120px] p-2">
                            <p class="text-[6px] md:text-[9px] lg:text-[12px] font-inter font-normal leading-[7px] md:leading-[11px] lg:leading-[15px] text-left text-[#3d3d3d] break-words">{{ $setting->updatedBy->name ?? 'N/A' }}</p>
                        </td>
                    </tr>
                    @empty
                    <tr>
                        <td colspan="9" class="p-8 text-center">
                            <p class="text-[14px] md:text-[16px] lg:text-[18px] font-inter font-normal text-center text-[#666]">No settings found</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
        ...
        <div class="flex flex-row justify-center items-center w-full p-4 bg-white rounded-b-[10px]">
            <div class="pagination-controls">
                @if($settings->currentPage() > 1)
                    <a href="{{ $settings->previousPageUrl() }}" class="btn btn-secondary btn-sm">Previous</a>
                @else
                ...
                @if($settings->lastPage() > 0)
                    ...
                    <div class="flex items-center gap-2">
                        @if($start > 1)
                            <a href="{{ $settings->url(1) }}" class="page-number">1</a>
                            @if($start > 2)
                        ...
                        @for($i = $start; $i <= $end; $i++)
                            ...
                            @else
                                <a href="{{ $settings->url($i) }}" class="page-number">{{ $i }}</a>
                            @endif
                        @endfor
                        
                        @if($end < $settings->lastPage())
                            @if($end < $settings->lastPage() - 1)
                                <span class="text-sm text-gray-500">...</span>
                            @endif
                            <a href="{{ $settings->url($settings->lastPage()) }}" class="page-number">{{ $settings->lastPage() }}</a>
                        @endif
                    </div>
                @else
                ...
                @if($settings->currentPage() < $settings->lastPage())
                    <a href="{{ $settings->nextPageUrl() }}" class="btn btn-secondary btn-sm">Next</a>
                @else
                ...
                <div class="page-dropdown-container">
                    ...
                    <select class="bg-gray-100 rounded-lg px-3 py-1 text-sm border border-gray-300 focus:outline-none focus:border-[#214589]">
                        <option>{{ $settings->currentPage() }}</option>
                    </select>
                    <span class="text-sm text-gray-700">of <span class="inline">{{ $settings->lastPage() }}</span></span>
                </div>
            </div>
        </div>
    </div>
