...
Route::middleware(['auth', 'download.logging', 'upload.logging', 'pageview.logging', 'report.logging'])->group(function () {
    ...
    Route::prefix('marketing')->name('marketing.')->group(function () {
        Route::get('/', function () { return view('marketing.dashboard'); })->name('dashboard');
    ...
    Route::prefix('operational')->name('operational.')->group(function () {
        ...
        Route::get('/', function () { return view('operational.dashboard'); })->name('dashboard');
        ...
        Route::get('force-majeure-dashboard', function () { return view('operational.force-majeure-dashboard'); })->name('force-majeure-dashboard');
    ...
    Route::prefix('finance')->name('finance.')->group(function () {
        ...
        Route::post('invoices/{invoice}/email', [InvoiceController::class, 'emailInvoice'])->name('finance.invoices.email')->middleware('permission:invoices.update');
        ...
        Route::get('invoices/export', [InvoiceController::class, 'export'])->name('invoices.export')->middleware('permission:invoices.view');
        Route::post('invoices/{invoice}/send', [InvoiceController::class, 'send'])->name('invoices.send')->middleware('permission:invoices.edit');
        Route::post('invoices/{invoice}/mark-paid', [InvoiceController::class, 'markPaid'])->name('invoices.mark-paid')->middleware('permission:invoices.edit');
        Route::post('invoices/{invoice}/cancel', [InvoiceController::class, 'cancel'])->name('invoices.cancel')->middleware('permission:invoices.edit');
        Route::post('invoices/{invoice}/regenerate', [InvoiceController::class, 'regenerate'])->name('invoices.regenerate')->middleware('permission:invoices.create');
        Route::post('invoices/regenerate-missing', [InvoiceController::class, 'regenerateMissing'])->name('invoices.regenerate-missing')->middleware('permission:invoices.create');
        Route::post('invoices/bulk-delete', [InvoiceController::class, 'bulkDelete'])->name('invoices.bulk-delete')->middleware('permission:invoices.delete');
        Route::post('invoices/bulk-send', [InvoiceController::class, 'bulkSend'])->name('invoices.bulk-send')->middleware('permission:invoices.edit');
        Route::post('invoices/auto-generate', [InvoiceController::class, 'autoGenerateInvoice'])->name('invoices.auto-generate')->middleware('permission:invoices.create');
        Route::get('invoices/contracts-ready', [InvoiceController::class, 'getContractsReadyForInvoice'])->name('invoices.contracts-ready')->middleware('permission:invoices.view');
        Route::post('invoices/{invoice}/update-delivery', [InvoiceController::class, 'updateDeliveryInfo'])->name('invoices.update-delivery')->middleware('permission:invoices.edit');
        Route::post('invoices/{invoice}/cancel-faktur', [InvoiceController::class, 'cancelFakturPajak'])->name('invoices.cancel-faktur')->middleware('permission:invoices.edit');
        ...
        Route::match(['get', 'post'], 'invoices/{invoice}/download-combined', [InvoiceController::class, 'downloadCombined'])->name('invoices.download-combined')->middleware('permission:invoices.view');
        Route::post('invoices/{invoice}/approve', [InvoiceController::class, 'approve'])->name('invoices.approve')->middleware('permission:invoices.edit');
        Route::post('invoices/{invoice}/tax-approve', [InvoiceController::class, 'taxApprove'])->name('invoices.tax-approve')->middleware('permission:invoices.edit');
        Route::post('invoices/{invoice}/update-date-preference', [InvoiceController::class, 'updateDatePreference'])->name('invoices.update-date-preference')->middleware('permission:invoices.edit');
        Route::post('invoices/{invoice}/reload-tax', [InvoiceController::class, 'reloadTaxData'])->name('invoices.reload-tax')->middleware('permission:invoices.edit');
        Route::get('invoices/{invoice}/print', [InvoiceController::class, 'printInvoice'])->name('invoices.print')->middleware('permission:invoices.view');
        Route::get('invoices/{invoice}/delivery-receipt', [InvoiceController::class, 'exportDeliveryReceipt'])->name('invoices.delivery-receipt')->middleware('permission:invoices.view');
        // Invoice Generation Enhancement routes
        Route::post('invoices/auto-generate-rental-period', [InvoiceController::class, 'autoGenerateInvoiceForRentalPeriod'])->name('invoices.auto-generate-rental-period')->middleware('permission:invoices.create');
        Route::get('invoices/rental-periods/{contractId}', [InvoiceController::class, 'getRentalPeriods'])->name('invoices.rental-periods')->middleware('permission:invoices.view');
        Route::post('invoices/generate-multiple-periods', [InvoiceController::class, 'generateInvoicesForMultiplePeriods'])->name('invoices.generate-multiple-periods')->middleware('permission:invoices.create');
    ...
    Route::prefix('warehouse')->name('warehouse.')->group(function () {
        Route::get('/', function () { return view('warehouse.dashboard'); })->name('dashboard');
        ...
        Route::resource('inventory-issuings', InventoryIssuingController::class)->middleware('permission:warehouse.inventory-issuings.view');
        ...
        Route::resource('warehouses', WarehouseController::class)->middleware('permission:warehouse.warehouses.view');
    ...
    Route::prefix('company')->name('company.')->group(function () {
        Route::get('/', function () { return view('company.dashboard'); })->name('dashboard');
    ...
    Route::prefix('other')->name('other.')->group(function () {
        Route::get('/', function () { return view('other.dashboard'); })->name('dashboard');
        ...
        Route::get('test-route/{id}', function($id) { return "Test route with ID: " . $id; })->name('test.route');
        Route::get('test-model/{masterOption}', function(\App\Models\MasterOption $masterOption) { return "Test model binding with ID: " . $masterOption->id; })->name('test.model');
    ...
    Route::prefix('setting')->name('setting.')->group(function () {
        Route::get('/', function () { return view('setting.dashboard'); })->name('dashboard');
        Route::resource('theme-settings', ThemeSettingController::class);
    });

    // Report Routes
    Route::prefix('report')->name('report.')->group(function () {
        Route::get('/', function () { return view('report.dashboard'); })->name('dashboard');
