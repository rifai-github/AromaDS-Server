...
Route::middleware(['auth', 'download.logging', 'upload.logging', 'pageview.logging', 'report.logging'])->group(function () {
    ...
    Route::prefix('warehouse')->name('warehouse.')->group(function () {
        ...
        Route::post('inventory-transfers/{inventoryTransfer}/submit-approval', [InventoryController::class, 'submitTransferForApproval'])->name('inventory-transfers.submit-approval')->middleware('permission:warehouse.inventory-transfers.submit,warehouse.inventory-transfers.submit.create,warehouse.inventory-transfers.submit.approve');
        ...
        Route::post('inventory-transfers/{inventoryTransfer}/mark-transferred', [InventoryController::class, 'markTransferAsTransferred'])->name('inventory-transfers.mark-transferred')->middleware('permission:warehouse.inventory-transfers.transfer,warehouse.inventory-transfers.transfer.create,warehouse.inventory-transfers.transfer.approve');
        Route::post('inventory-transfers/{inventoryTransfer}/mark-received', [InventoryController::class, 'markTransferAsReceived'])->name('inventory-transfers.mark-received')->middleware('permission:warehouse.inventory-transfers.receive,warehouse.inventory-transfers.receive.create,warehouse.inventory-transfers.receive.approve');
